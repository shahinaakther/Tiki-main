            ...
            <div class="card-body">
                <form action="{{ route("admin.routes.store") }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="origin" value="{{ old("origin") }}" name="origin"
                                   autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="destination" value="{{ old("destination") }}"
                                   name="destination">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" step="any" class="form-control" id="distance" value="{{ old("distance") }}"
                                   name="distance">
                        </div>
                    </div>
